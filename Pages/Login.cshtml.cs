        ...
        public void OnPost() 
        {
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    String selectall = "SELECT * FROM [Students/Étudiants] WHERE [Student ID/Identifiant d'étudiant] = " + convertedID + " AND [Student Password/Mot de passe étudiant] = HASHBYTES('SHA1', '" + Request.Form["password"] + "');";
